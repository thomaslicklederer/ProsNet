within ProsNet.Fluid.Pumps.BaseClasses.Validation;
model PowerInterface "Simple model to validate PowerInterface"
  extends Modelica.Icons.Example;
  ProsNet.Fluid.Pumps.BaseClasses.PowerInterface powCoo(motorCooledByFluid=true,
  ...
  ProsNet.Fluid.Pumps.BaseClasses.PowerInterface powNonCoo(motorCooledByFluid=
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/Movers/BaseClasses/Validation/PowerInterface.mos"
        "Simulate and plot"));
end PowerInterface;
