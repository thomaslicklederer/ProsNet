...
model FlowMachineInterface "Simple model to validate FlowMachineInterface"
  ...
  ProsNet.Fluid.Pumps.BaseClasses.FlowMachineInterface eff(
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/Movers/BaseClasses/Validation/FlowMachineInterface.mos"
        "Simulate and plot"));
