...
package Obsolete
  model Heater_Cooler_T_obs "Heater/Cooler with prescribed outlet temperature"

    redeclare replaceable package Medium = ProsNet.Media.Water;

    extends ProsNet.Fluid.HeatExchangers.BaseClasses.PartialPrescribedOutlet(
      outCon(
        final QMin_flow = -QMax_flow,
