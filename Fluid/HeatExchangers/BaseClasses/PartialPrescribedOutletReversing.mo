...
partial model PartialPrescribedOutletReversing
  ...
  extends ProsNet.Fluid.Interfaces.TwoPortFlowResistanceParameters(
...
protected
  ProsNet.Fluid.FixedResistances.PressureDrop preDro(
  ...
  ProsNet.Fluid.Interfaces.PrescribedOutletReversing outCon(
    redeclare final package Medium = Medium,
    final allowFlowReversal=allowFlowReversal,
...
end PartialPrescribedOutletReversing;
