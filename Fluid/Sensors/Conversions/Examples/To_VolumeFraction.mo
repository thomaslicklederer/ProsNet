within ProsNet.Fluid.Sensors.Conversions.Examples;
model To_VolumeFraction "Example problem for conversion model"
  ...
  ProsNet.Fluid.Sensors.Conversions.To_VolumeFraction conMasVolFra(MMMea=
  ...
  ProsNet.Fluid.Sensors.TraceSubstances senCO2(redeclare package Medium =
  ...
  ProsNet.Fluid.Sensors.VolumeFlowRate senVolFlo(redeclare package Medium =
  ...
  ProsNet.Fluid.Sensors.TraceSubstancesTwoPort senTraSubPeo(
    m_flow_nominal=0.1,
    redeclare package Medium = Medium,
    C_start=0,
  ...
  ProsNet.Fluid.Sensors.TraceSubstancesTwoPort senTraSubFre(
    m_flow_nominal=0.1,
    redeclare package Medium = Medium,
    C_start=0,
    initType=Modelica.Blocks.Types.Init.InitialState)
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/Sensors/Conversions/Examples/To_VolumeFraction.mos"
        "Simulate and plot"),
