...
model VolumeFlowRate "Test model for the volume flow rate sensor"
  ...
  ProsNet.Fluid.Sensors.VolumeFlowRate senDyn(redeclare package Medium =
        Medium, m_flow_nominal=10)
    "Sensor configured to use a dynamic model for the density"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
  ProsNet.Fluid.Sensors.VolumeFlowRate senSteSta(
    redeclare package Medium = Medium,
    m_flow_nominal=10,
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/Sensors/Examples/VolumeFlowRate.mos"
        "Simulate and plot"),
