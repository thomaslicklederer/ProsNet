within ProsNet.Fluid.Sensors.Examples;
model Pressure "Test model for the pressure sensor"
  extends Modelica.Icons.Example;

  package Medium = ProsNet.Media.Air
    "Medium model";
  ...
  ProsNet.Fluid.Sources.MassFlowSource_T masFloRat(
    redeclare package Medium = Medium,
    use_T_in=false,
    X={0.02,0.98},
    use_m_flow_in=true,
  ...
  ProsNet.Fluid.FixedResistances.PressureDrop dp(
    redeclare package Medium = Medium,
    m_flow_nominal=10,
  ...
  ProsNet.Fluid.Sensors.Pressure senPre_a(redeclare package Medium = Medium)
    "Pressure sensor at resistance port a"
    annotation (Placement(transformation(extent={{-22,20},{-2,40}})));
  ProsNet.Fluid.Sensors.Pressure senPre_b(redeclare package Medium = Medium)
    "Pressure sensor at resistance port b"
    annotation (Placement(transformation(extent={{20,20},{40,40}})));
  ProsNet.Fluid.Sensors.RelativePressure senRelPre(redeclare package Medium =
...
__Dymola_Commands(file="modelica://ProsNet/Resources/Scripts/Dymola/Fluid/Sensors/Examples/Pressure.mos"
        "Simulate and plot"),
