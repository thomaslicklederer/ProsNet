...
model PrescribedOutlet_X_wSetOnly
  ...
  extends ProsNet.Fluid.Interfaces.Examples.BaseClasses.PrescribedOutletState(
...
__Dymola_Commands(file= "modelica://IBPSA/Resources/Scripts/Dymola/Fluid/Interfaces/Examples/PrescribedOutlet_X_wSetOnly.mos"
        "Simulate and plot"),
