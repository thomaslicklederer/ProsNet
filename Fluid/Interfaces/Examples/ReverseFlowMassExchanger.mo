...
package Medium = IBPSA.Media.Air;
  ...
  IBPSA.Fluid.FixedResistances.PressureDrop res4(
    redeclare package Medium = Medium,
    m_flow_nominal=1,
    from_dp=true,
    linearized=false,
  ...
  IBPSA.Fluid.Sensors.SpecificEnthalpy senEnt3(redeclare package Medium =
        Medium)
  ...
  IBPSA.Fluid.Sensors.MassFraction senMas3(redeclare package Medium = Medium)
    annotation (Placement(transformation(extent={{-270,140},{-250,160}})));
  IBPSA.Fluid.Sensors.SpecificEnthalpy senEnt4(redeclare package Medium =
        Medium)
  ...
  IBPSA.Fluid.Sensors.MassFraction senMas4(redeclare package Medium = Medium)
  ...
  IBPSA.Fluid.Sources.Boundary_pT sink1(redeclare package Medium = Medium,
      nPorts=2) "Fluid sink" annotation (Placement(transformation(extent={{10,-10},
            {-10,10}}, origin={40,98})));
  IBPSA.Fluid.Sensors.SpecificEnthalpy senEnt1(redeclare package Medium =
        Medium)
  ...
  IBPSA.Fluid.Sensors.MassFraction senMas1(redeclare package Medium = Medium)
  ...
  IBPSA.Fluid.Sensors.SpecificEnthalpy senEnt2(redeclare package Medium =
        Medium)
    annotation (Placement(transformation(extent={{60,-60},{80,-40}})));
  IBPSA.Fluid.Sensors.MassFraction senMas2(redeclare package Medium = Medium)
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/Interfaces/Examples/ReverseFlowMassExchanger.mos"
        "Simulate and plot"),
