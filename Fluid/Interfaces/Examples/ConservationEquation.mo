...
extends Modelica.Icons.Example;
 package Medium = IBPSA.Media.Water "Medium model";
  ProsNet.Fluid.Interfaces.ConservationEquation dyn(
  ...
  ProsNet.Fluid.Interfaces.StaticTwoPortConservationEquation ste(
    redeclare package Medium = Medium,
    m_flow_nominal=0.01,
    show_T=true,
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/Interfaces/Examples/ConservationEquation.mos"
        "Simulate and plot"),
