...
model StaticFourPortHeatMassExchanger
  ...
  extends ProsNet.Fluid.Interfaces.FourPortFlowResistanceParameters(final
...
protected
  ProsNet.Fluid.Interfaces.StaticTwoPortHeatMassExchanger bal1(
  ...
  ProsNet.Fluid.Interfaces.StaticTwoPortHeatMassExchanger bal2(
