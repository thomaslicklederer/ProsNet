within ProsNet.Fluid.BaseClasses.FlowModels;
...
algorithm
 ...
 annotation (Inline=false,
             ...
             derivative(order=1, zeroDerivative=k, zeroDerivative=m_flow_turbulent)=
               ProsNet.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow_der,
             inverse(m_flow=ProsNet.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp(
