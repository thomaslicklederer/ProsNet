within ProsNet.Fluid.BaseClasses.FlowModels.Validation;
...
equation
  ...
  dp = ProsNet.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow(
    m_flow=m_flow,
    k=k,
...
experiment(
      ...
      StopTime=2,
      Tolerance=1e-8),
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/BaseClasses/FlowModels/Validation/BasicFlowFunction_m_flow_DerivativeCheck2.mos"
        "Simulate and plot"),
