within ProsNet.Fluid.MixingVolumes.Examples;
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/MixingVolumes/Examples/MixingVolumePrescribedHeatFlowRate.mos"
        "Simulate and plot"));
