within ProsNet.Fluid.MixingVolumes.Validation.BaseClasses;
partial model MixingVolumeReverseFlow
 ...
 package Medium = IBPSA.Media.Air "Medium model";
  ...
  IBPSA.Fluid.Sources.Boundary_pT bou(
    redeclare package Medium = Medium,
    T=303.15,
    nPorts=2) "Boundary condition" annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=180,
        origin={70,-20})));
  replaceable ProsNet.Fluid.MixingVolumes.MixingVolume volDyn constrainedby
    ProsNet.Fluid.MixingVolumes.BaseClasses.MixingVolumeHeatPort(
    redeclare package Medium = Medium,
    V=1,
    nPorts=2,
  ...
  replaceable ProsNet.Fluid.MixingVolumes.MixingVolume volSte constrainedby
    ProsNet.Fluid.MixingVolumes.BaseClasses.MixingVolumeHeatPort(
    redeclare package Medium = Medium,
