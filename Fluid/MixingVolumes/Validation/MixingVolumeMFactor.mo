...
model MixingVolumeMFactor
  ...
  extends ProsNet.Fluid.MixingVolumes.Validation.MixingVolumeMassFlow(
    sou(X={0.02,0.98}, T=Medium.T_default),
    vol(mSenFac=10),
    bou(nPorts=3));
  ProsNet.Fluid.MixingVolumes.MixingVolume volMFactor(
  ...
  ProsNet.Fluid.MixingVolumes.MixingVolume vol1(
    redeclare package Medium = Medium,
    V=10,
    nPorts=2,
    m_flow_nominal=m_flow_nominal,
