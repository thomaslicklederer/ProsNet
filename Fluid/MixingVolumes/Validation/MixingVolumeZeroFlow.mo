...
model MixingVolumeZeroFlow
  ...
  ProsNet.Fluid.MixingVolumes.MixingVolume volNonLinSys(
    nPorts=2,
  ...
  ProsNet.Fluid.MixingVolumes.MixingVolume volT(
    nPorts=2,
    redeclare package Medium = Medium,
    m_flow_nominal=1,
    V=1,
  ...
  ProsNet.Fluid.MixingVolumes.MixingVolume volLinSys(
    nPorts=2,
    redeclare package Medium = Medium,
    m_flow_nominal=1,
    V=1,
  ...
  ProsNet.Fluid.MixingVolumes.MixingVolume volQflow(
    nPorts=2,
    redeclare package Medium = Medium,
    m_flow_nominal=1,
    V=1,
