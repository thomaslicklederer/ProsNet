...
model MixingVolume "Test model for mixing volumes"
  ...
  IBPSA.Fluid.Sensors.EnthalpyFlowRate entFloRat(
    ...
    m_flow_nominal=2) "Enthalpy flow rate"
          ...
          extent={{40,50},{60,70}})));
  IBPSA.Fluid.Sensors.EnthalpyFlowRate entFloRat1(
    redeclare package Medium = Medium,
    m_flow_nominal=2) "Enthalpy flow rate"
                                     annotation (Placement(transformation(
          extent={{40,0},{60,20}})));
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/MixingVolume.mos"
        "Simulate and plot"),
