within ProsNet.Fluid.MixingVolumes.Validation;
 ...
 package Medium = IBPSA.Media.Air(extraPropertiesNames={"CO2"})
  ...
  IBPSA.Fluid.Sources.Boundary_pT bou(
    ...
    nPorts=2) "Boundary condition" annotation (Placement(transformation(
        ...
        rotation=180,
        origin={50,-20})));
  ProsNet.Fluid.MixingVolumes.MixingVolume volDyn(
    redeclare package Medium = Medium,
    V=1,
    nPorts=2,
  ...
  ProsNet.Fluid.MixingVolumes.MixingVolume volSte(
    redeclare package Medium = Medium,
    V=1,
    nPorts=2,
    m_flow_nominal=m_flow_nominal,
...
First implementation.
 ...
 __Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/MixingVolumeTraceSubstance.mos"
        "Simulate and plot"),
