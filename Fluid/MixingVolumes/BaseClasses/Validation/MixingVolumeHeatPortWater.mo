within ProsNet.Fluid.MixingVolumes.BaseClasses.Validation;
model MixingVolumeHeatPortWater
  ...
  replaceable ProsNet.Fluid.MixingVolumes.BaseClasses.MixingVolumeHeatPort vol[nEle]
    constrainedby ProsNet.Fluid.MixingVolumes.BaseClasses.MixingVolumeHeatPort(
...
__Dymola_Commands(file=
  "modelica://IBPSA/Resources/Scripts/Dymola/Fluid/MixingVolumes/BaseClasses/Validation/MixingVolumeHeatPortWater.mos"
  "Simulate and plot"));
