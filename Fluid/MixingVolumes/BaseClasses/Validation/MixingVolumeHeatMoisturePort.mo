...
model MixingVolumeHeatMoisturePort
  ...
  extends
    ProsNet.Fluid.MixingVolumes.BaseClasses.Validation.MixingVolumeHeatPortWater(
      redeclare package Medium = IBPSA.Media.Air, redeclare
      ProsNet.Fluid.MixingVolumes.BaseClasses.MixingVolumeHeatMoisturePort vol);
...
__Dymola_Commands(file=
  "modelica://IBPSA/Resources/Scripts/Dymola/Fluid/MixingVolumes/BaseClasses/Validation/MixingVolumeHeatMoisturePort.mos"
  "Simulate and plot"));
