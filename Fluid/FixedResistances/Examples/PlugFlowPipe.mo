...
model PlugFlowPipe "Simple example of plug flow pipe"
  ...
  replaceable package Medium = ProsNet.Media.Water "Medium in the pipe" annotation (
  ...
  ProsNet.Fluid.FixedResistances.PlugFlowPipe pip(
    redeclare package Medium = Medium,
    nPorts=1,
    dh=0.1,
    length=100,
  ...
  ProsNet.Fluid.Sources.MassFlowSource_T sou(
    nPorts=1,
    redeclare package Medium = Medium,
    use_T_in=true,
  ...
  ProsNet.Fluid.Sensors.TemperatureTwoPort senTemOut(
    redeclare package Medium = Medium,
    m_flow_nominal=1,
    T_start=323.15) "Temperature sensor"
    annotation (Placement(transformation(extent={{30,-10},{50,10}})));
  ProsNet.Fluid.Sensors.TemperatureTwoPort senTemIn(
    redeclare package Medium = Medium,
    m_flow_nominal=1,
    T_start=323.15) "Temperature sensor"
