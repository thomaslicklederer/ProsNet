...
model PressureDrop
 ...
 package Medium = ProsNet.Media.Air "Medium model";
  ...
  ProsNet.Fluid.FixedResistances.PressureDrop res(
    redeclare package Medium = Medium,
    m_flow_nominal=0.2,
    from_dp=true,
...
__Dymola_Commands(file="modelica://ProsNet/Resources/Scripts/Dymola/Fluid/FixedResistances/Examples/PressureDrop.mos"
        "Simulate and plot"),
