within ProsNet.Fluid.FixedResistances.BaseClasses;
model PlugFlowCore
  ...
  ProsNet.Fluid.FixedResistances.HydraulicDiameter res(
  ...
  ProsNet.Fluid.FixedResistances.BaseClasses.PlugFlow del(
    redeclare final package Medium = Medium,
  ...
  ProsNet.Fluid.FixedResistances.BaseClasses.PlugFlowHeatLoss heaLos_a(
    redeclare final package Medium = Medium,
    final C=C,
    final R=R,
    final m_flow_small=m_flow_small,
  ...
  ProsNet.Fluid.FixedResistances.BaseClasses.PlugFlowHeatLoss heaLos_b(
    redeclare final package Medium = Medium,
    final C=C,
    final R=R,
    final m_flow_small=m_flow_small,
  ...
  ProsNet.Fluid.FixedResistances.BaseClasses.PlugFlowTransportDelay timDel(
    final length=length,
    final dh=dh,
