...
model PlugFlowHeatLoss
  ...
  extends ProsNet.Fluid.Interfaces.PartialTwoPortTransport(final
      allowFlowReversal=true, final dp_start=0);
...
equation
  ...
  heatPort.Q_flow = -ProsNet.Utilities.Math.Functions.spliceFunction(
