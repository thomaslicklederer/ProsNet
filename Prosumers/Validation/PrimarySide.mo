...
model PrimarySide
  ...
  Fluid.Sources.Boundary_pT bou2(nPorts=1) annotation (Placement(transformation(
        ...
        rotation=180,
        origin={92,6})));
  Fluid.Sources.MassFlowSource_T boundary(m_flow=0.35,
    T=373.15,                                          nPorts=1)
  ...
  BaseClasses.PrimarySide_new priSide(
    ...
    redeclare ProsNet.Fluid.Pumps.Data.Pumps.IMP.NMTPlus152025to40 feedinPer)
...
equation
  connect(mu.y, priSide.mu) annotation (Line(points={{-57,68},{-24,68},{-24,15.8},{-12,15.8}},
        color={255,127,0}));
