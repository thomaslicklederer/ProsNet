...
model Test_TwoProsumers
  new_prosumer_models.heat_transfer_station B1(n=0.5, redeclare
      Fluid.Pumps.Data.Pumps.IMP.NMTSmart25_120to180 feedinPer)
        ...
        rotation=0,
        origin={-48,8})));
  Controller_PID_based.PID_Q_T_weighted_old Ctrl1(alpha_prim_prod=0.35, alpha_sec_cons=
  ...
  new_prosumer_models.heat_transfer_station B2(n=0.5, redeclare
      Fluid.Pumps.Data.Pumps.IMP.NMTSmart25_120to180 feedinPer)
        ...
        rotation=0,
        origin={50,8})));
  Controller_PID_based.PID_Q_T_weighted_old Ctrl2(alpha_prim_prod=0.35, alpha_sec_cons=
        0.35) annotation (Placement(transformation(
        extent={{-12,-17},{12,17}},
        rotation=0,
        origin={52,73})));
