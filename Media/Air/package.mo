...
First implementation.
  ...
  constant GasProperties dryair(
    ...
    cv =   ProsNet.Utilities.Psychrometrics.Constants.cpAir
  ...
  constant GasProperties steam(
    ...
    cv =   ProsNet.Utilities.Psychrometrics.Constants.cpSte
  ...
  constant Modelica.SIunits.SpecificEnergy h_fg=
    ProsNet.Utilities.Psychrometrics.Constants.h_fg
    "Latent heat of evaporation of water";
  constant Modelica.SIunits.SpecificHeatCapacity cpWatLiq=
    ProsNet.Utilities.Psychrometrics.Constants.cpWatLiq
