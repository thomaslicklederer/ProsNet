within ProsNet.Utilities.Psychrometrics;
...
equation
  if approximateWetBulb then
    ...
    rh_per = 100*p/
      ProsNet.Utilities.Psychrometrics.Functions.saturationPressure(
      TDryBul)*Xi[iWat]/(Xi[iWat] + ProsNet.Utilities.Psychrometrics.Constants.k_mair
      *(1 - Xi[iWat]));
    ...
    XiSat = ProsNet.Utilities.Psychrometrics.Functions.X_pSatpphi(
            pSat=
        ProsNet.Utilities.Psychrometrics.Functions.saturationPressureLiquid(
         TWetBul),
            p=p,
            phi=1);
    (TWetBul - ProsNet.Utilities.Psychrometrics.Constants.T_ref)*((1 - Xi[
      iWat])*ProsNet.Utilities.Psychrometrics.Constants.cpAir +
      XiSatRefIn*ProsNet.Utilities.Psychrometrics.Constants.cpSte + (Xi[
      iWat] - XiSatRefIn)*ProsNet.Utilities.Psychrometrics.Constants.cpWatLiq)
      = (TDryBul - ProsNet.Utilities.Psychrometrics.Constants.T_ref)*((1 -
      Xi[iWat])*ProsNet.Utilities.Psychrometrics.Constants.cpAir + Xi[
      iWat]*ProsNet.Utilities.Psychrometrics.Constants.cpSte) + (Xi[iWat] -
      XiSatRefIn)*ProsNet.Utilities.Psychrometrics.Constants.h_fg;
    TDryBul_degC = 0;
    rh_per       = 0;
  end if;
