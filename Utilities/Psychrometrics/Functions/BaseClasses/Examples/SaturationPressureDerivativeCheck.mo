...
equation
  ...
  y = ProsNet.Utilities.Psychrometrics.Functions.saturationPressure(
     TSat=T);
  der(y)=der(y_comp);
  err = y-y_comp;
...
annotation (
  __Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Utilities/Psychrometrics/Functions/BaseClasses/Examples/SaturationPressureDerivativeCheck.mos"
        "Simulate and plot"),
      experiment(
        StartTime=-1,
        StopTime=1,
