...
equation
  ...
  X_w = ProsNet.Utilities.Psychrometrics.Functions.X_pSatpphi(
              pSat=pSat,
              p=p,
              phi=phi);
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Utilities/Psychrometrics/Functions/Examples/X_pSatpphi.mos"
