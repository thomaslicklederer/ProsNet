...
equation
  ...
  phi = ProsNet.Utilities.Psychrometrics.Functions.phi_pTX(
              p=p,
              T=T,
              X_w=X_w);
  X_inv = ProsNet.Utilities.Psychrometrics.Functions.X_pTphi(
              p=p,
              T=T,
              phi=phi);
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Utilities/Psychrometrics/Functions/Examples/phi_pTX.mos"
        "Simulate and plot"),
