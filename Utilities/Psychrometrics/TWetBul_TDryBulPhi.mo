    ...
    XiSat = ProsNet.Utilities.Psychrometrics.Functions.X_pSatpphi(
        ...
        ProsNet.Utilities.Psychrometrics.Functions.saturationPressureLiquid(
         TWetBul),
            p=p,
            phi=1);
    XiDryBul = ProsNet.Utilities.Psychrometrics.Functions.X_pSatpphi(
            p=p,
            pSat=
        ProsNet.Utilities.Psychrometrics.Functions.saturationPressureLiquid(
         TDryBul),
            phi=phi);
    (TWetBul - ProsNet.Utilities.Psychrometrics.Constants.T_ref)*((1 -
      XiDryBul)*ProsNet.Utilities.Psychrometrics.Constants.cpAir +
      XiSatRefIn*ProsNet.Utilities.Psychrometrics.Constants.cpSte + (
      XiDryBul - XiSatRefIn)*ProsNet.Utilities.Psychrometrics.Constants.cpWatLiq)
      = (TDryBul - ProsNet.Utilities.Psychrometrics.Constants.T_ref)*((1 -
      XiDryBul)*ProsNet.Utilities.Psychrometrics.Constants.cpAir +
      XiDryBul*ProsNet.Utilities.Psychrometrics.Constants.cpSte) + (
      XiDryBul - XiSatRefIn)*ProsNet.Utilities.Psychrometrics.Constants.h_fg;
