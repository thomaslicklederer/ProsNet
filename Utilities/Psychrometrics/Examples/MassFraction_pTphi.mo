...
model MassFraction_pTphi "Unit test for dew point temperature calculation"
  ...
  ProsNet.Utilities.Psychrometrics.X_pTphi masFra1
  ...
  ProsNet.Utilities.Psychrometrics.X_pTphi masFra2(use_p_in=false)
    "Mass fraction computation"
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Utilities/Psychrometrics/Examples/MassFraction_pTphi.mos"
        "Simulate and plot"));
