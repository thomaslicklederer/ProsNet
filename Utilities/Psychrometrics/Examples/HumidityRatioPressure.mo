...
model HumidityRatioPressure "Unit test for humidity ratio model"
 ...
 package Medium = IBPSA.Media.Air "Medium model"
  ...
  ProsNet.Utilities.Psychrometrics.pW_X vapPre(use_p_in=true)
  ...
  Modelica.Blocks.Sources.Constant p(k=101325) "Pressure"
            ...
            {-60,40}})));
  ProsNet.Utilities.Psychrometrics.X_pW humRat(use_p_in=true)
    annotation (Placement(transformation(extent={{40,0},{60,20}})));
  IBPSA.Utilities.Diagnostics.AssertEquality assertEquality(threShold=1E-5)
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Utilities/Psychrometrics/Examples/HumidityRatioPressure.mos"
        "Simulate and plot"));
