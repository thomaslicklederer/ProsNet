...
model Density_pTX "Model to test the density computation"
 ...
 package Medium = IBPSA.Media.Air "Medium model"
  ...
  ProsNet.Utilities.Psychrometrics.Density_pTX den "Density"
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Utilities/Psychrometrics/Examples/Density_pTX.mos"
        "Simulate and plot"),
