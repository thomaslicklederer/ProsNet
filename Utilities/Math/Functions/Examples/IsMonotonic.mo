within ProsNet.Utilities.Math.Functions.Examples;
model IsMonotonic
...
// Tests with weak monotonicity
    //strictly increasing
  assert(ProsNet.Utilities.Math.Functions.isMonotonic(x_incStrict,
    strict=false), "Error. Function should have returned true.");
     //not monotonic
  assert(false == ProsNet.Utilities.Math.Functions.isMonotonic(
    x_notMon, strict=false), "Error. Function should have returned true.");
     //weakly increasing
  assert(ProsNet.Utilities.Math.Functions.isMonotonic(x_incWeak,
    strict=false), "Error. Function should have returned true.");
  ...
  assert(false == ProsNet.Utilities.Math.Functions.isMonotonic(
    ...
    //strictly decreasing
  assert(ProsNet.Utilities.Math.Functions.isMonotonic({2.5,2,0.1},
    strict=false), "Error. Function should have returned true.");
     //weakly decreasing
  assert(ProsNet.Utilities.Math.Functions.isMonotonic({3,1,1,0.5},
    strict=false), "Error. Function should have returned true.");
...
// Tests with strict monotonicity
  ...
  assert(ProsNet.Utilities.Math.Functions.isMonotonic(x_incStrict,
    strict=true), "Error. Function should have returned true.");
     //not monotonic
  assert(false == ProsNet.Utilities.Math.Functions.isMonotonic(
    x_notMon, strict=true), "Error. Function should have returned true.");
     //weakly increasing
  assert(false == ProsNet.Utilities.Math.Functions.isMonotonic(
  ...
  assert(false == ProsNet.Utilities.Math.Functions.isMonotonic(
    ...
    //strictly decreasing
  assert(ProsNet.Utilities.Math.Functions.isMonotonic(x_decStrict,
    strict=true), "Error. Function should have returned true.");
     //weakly decreasing
  assert(false == ProsNet.Utilities.Math.Functions.isMonotonic(
