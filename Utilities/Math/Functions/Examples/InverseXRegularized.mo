...
equation
  ...
  y = ProsNet.Utilities.Math.Functions.inverseXRegularized(
              x=x,
              delta=delta,
              deltaInv=deltaInv,
              a=a,
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/InverseXRegularized.mos"
        "Simulate and plot"),
