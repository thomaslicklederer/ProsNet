...
initial algorithm
  ...
  d := ProsNet.Utilities.Math.Functions.splineDerivatives(
              x=xd,
              y=yd,
              ensureMonotonicity=false);
  dMonotone := ProsNet.Utilities.Math.Functions.splineDerivatives(
              x=xd,
              y=yd,
...
algorithm
  ...
  y :=
    ProsNet.Utilities.Math.Functions.cubicHermiteLinearExtrapolation(
              x=x,
              x1=xd[i],
              x2=xd[i + 1],
              y1=yd[i],
  ...
  annotation (
    __Dymola_Commands(file=
          "modelica://IBPSA/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/CubicHermite.mos"
        "Simulate and plot"),
...
<p align=\"center\"><img alt=\"image\" src=\"modelica://IBPSA/Resources/Images/Utilities/Math/Functions/Examples/cubicHermite.png\"/></p>
</html>", revisions="<html>
<ul>
<li>
