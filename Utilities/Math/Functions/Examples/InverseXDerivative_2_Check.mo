...
equation
  x = time^3*gain;
  y = ProsNet.Utilities.Math.Functions.inverseXRegularized(x=x, delta=
    delta);
...
experiment(
      ...
      StopTime=1.5,
      Tolerance=1e-08),
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/InverseXDerivative_2_Check.mos"
        "Simulate and plot"),
