...
model VectorFunctions "Test model for functions that take a vector as argument"
  ...
  ProsNet.Utilities.Math.Min minVec(nin=3)
  ...
  ProsNet.Utilities.Math.Max maxVec(nin=3)
    annotation (Placement(transformation(extent={{-20,-60},{0,-40}})));
  ProsNet.Utilities.Math.Average aveVec(nin=3)
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Utilities/Math/Examples/VectorFunctions.mos"
        "Simulate and plot"),
