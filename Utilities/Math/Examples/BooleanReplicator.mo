...
model BooleanReplicator "Test model for boolean replicator"
  ...
  ProsNet.Utilities.Math.BooleanReplicator booRep(nout=4)
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Utilities/Math/Examples/BooleanReplicator.mos"
        "Simulate and plot"),
