within ProsNet.Utilities.Math.Examples;
model IntegratorWithReset "Test model for integrator with reset"
  ...
  ProsNet.Utilities.Math.IntegratorWithReset intWitRes1(
    y_start=5,
  ...
  ProsNet.Utilities.Math.IntegratorWithReset intWitRes2(
    y_reset=10,
    y_start=-5,
  ...
  ProsNet.Utilities.Math.IntegratorWithReset intNoReset(
  ...
  ProsNet.Utilities.Math.IntegratorWithReset intDef
...
__Dymola_Commands(file="modelica://IBPSA/Resources/Scripts/Dymola/Utilities/Math/Examples/IntegratorWithReset.mos"
        "Simulate and plot"),
